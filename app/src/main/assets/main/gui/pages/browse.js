...
function resolveCategoryFetcher(cat, view) {
    ...
    const staticFetchers = {
        ...
        'anime-movies-row': () => Api.fetchAnimeMovies(),
        'anime-series-row': () => Api.fetchAnimeSeries(),
        ...
        'crime-series-row': () => Api.fetchCrimeSeries(),
        'mystery-series-row': () => Api.fetchMysterySeries(),
        'animation-series-row': () => Api.fetchAnimationSeries(),
        'family-series-row': () => Api.fetchFamilySeries(),
