...
export const Api = {
    ...
    async fetchTopRated() {
        try {
            const response = await fetch(`${BASE_URL}/movie/top_rated?api_key=${API_KEY}&include_adult=false`);
            const data = await response.json();
            return shuffleArray(data.results);
        } catch (error) {
    ...
    async _fetchDiscover(type, params) {
        try {
            ...
            const response = await fetch(`${BASE_URL}/discover/${type}?api_key=${API_KEY}&include_adult=false&${params}`);
            const data = await response.json();
            return shuffleArray(data.results);
        } catch (error) {
    ...
    async fetchPopularTV() {
        try {
            const response = await fetch(`${BASE_URL}/tv/popular?api_key=${API_KEY}&include_adult=false`);
            const data = await response.json();
            return shuffleArray(data.results);
        } catch (error) {
    ...
    async fetchTopRatedTV() {
        try {
            const response = await fetch(`${BASE_URL}/tv/top_rated?api_key=${API_KEY}&include_adult=false`);
            const data = await response.json();
            return shuffleArray(data.results);
        } catch (error) {
