    ...
    async loadPage(pageName, params = {}) {
        try {
            ...
            try {
                ...
                // Update page-specific Mobile CSS
                const pageMobileCssLink = document.getElementById('page-mobile-css');
                if (pageMobileCssLink) {
                    pageMobileCssLink.href = `css/${pageName}-mobile.css`;
                }
            } catch (cssError) {
