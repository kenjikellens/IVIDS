...
export async function init() {
    try {
        ...
        try {
            ...
            ErrorHandler.show('Failed to load some content. API may be unavailable.');
        }
        ...
        ErrorHandler.show('Failed to initialize home page. Some content may not be available.', () => init());
    }
}
    ...
    try {
        ...
        items.forEach(item => {
            try {
                ...
                img.onerror = () => {
                    if (loader.parentNode) loader.parentNode.removeChild(loader);
                    img.style.opacity = '1'; // Show broken image or placeholder
                };
