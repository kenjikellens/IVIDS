...
class SettingsManager {
    constructor() {
        ...
        // Ensure API content language matches saved setting
        try {
            Api.setLanguage(this.settings.language);
        } catch (e) {
    ...
    attachEventListeners() {
        ...
        if (languageSelect) {
            languageSelect.addEventListener('change', async (e) => {
                ...
                // Also update API content language so TMDb requests use the selected language
                try {
                    Api.setLanguage(e.target.value);
                } catch (err) {
                    console.warn('Api.setLanguage not available', err);
                }
            });
        }
        ...
        // Reset button (moved to its own setting)
