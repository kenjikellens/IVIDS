...
export async function init() {
    const [
        popular, topRated, actionAdventure, animation, crime, documentary, drama, family, kids, mystery, reality, scifiFantasy, soap, warPolitics, western, anime
    ] = await Promise.all([
        Api.fetchPopularTV(),
        Api.fetchTopRatedTV(),
    ...
    if (topRated) setupRow('top-rated-series-row', topRated);
