...
export async function init(params) {
    try {
        ...
        ErrorHandler.show('An error occurred while loading the page.', () => Router.loadPage('home'));
        Router.loadPage('home');
    }
}
...
async function loadSeasonEpisodes(seriesId, seasonNumber) {
    try {
        ...
        container.innerHTML = `<div style="display:flex;justify-content:center;padding:20px;">${getLoaderHtml()}</div>`;
